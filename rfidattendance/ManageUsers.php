    ...
    <div class="form-style-5 slideInDown animated">
        <form enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <input type="text" name="number" id="number" placeholder="Register Number...">
                <input type="email" name="email" id="email" placeholder="User Email...">
                <input type="text" name="phone" id="phone" placeholder="Phone Number..."> <!-- Changed input type to tel for phone number -->
